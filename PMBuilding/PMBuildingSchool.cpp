...
void PMBuildingSchool::generate(VBORenderManager& rendManager, Building& building) {
	initialize();

	if (building.subType == 0) {
		generateType0(rendManager, building);
	} else {
		//generateType1(rendManager, building);
	}
}

void PMBuildingSchool::generateType0(VBORenderManager& rendManager, Building& building) {
